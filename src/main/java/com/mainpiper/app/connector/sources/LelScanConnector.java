...
@Slf4j
@Getter
public class LelScanConnector extends ConnectorHTML implements ConnectorInterface {
	...
	public final Map<String, String> getMangaUrls(){
		  ...
		  //TODO make better first connection managment
		   Elements option = ConnectorUtils.tryFirstConnect(connector, WEBSITEURL, "option"); 
		   if(option == null)
			   return null;;
	...
	public Map<String, String> getChaptersUrl() {
		...
		//Variable Initialization
		   ...
		   Elements option = ConnectorUtils.tryLelscan(connector, this.mangaUrl, urlBis);
		   if(option == null)
			   return null;
	...
	public Map<String, String> getImageUrls(String chapterNumber) {
	   ...
	   Elements option = ConnectorUtils.tryConnect(connector, chapterUrl, "a");
	   if(option == null)
		   return null;
